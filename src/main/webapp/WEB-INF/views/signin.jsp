...
<div class="container">
    ...
    <div class="col-md-8 offset-md-4">
        ...
        <form method="POST" action="${pageContext.request.contextPath}/signin" class="needs-validation" novalidate>

            <div class="form-group">
                <label for="login">Username:</label>
                <input type="text" class="form-control w-25" id="login" placeholder="Enter username" name="login"
                       required>
